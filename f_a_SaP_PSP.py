...
def psp_for_SaP(protocolFile, multi_pipet, single_pipet, labware_list, MARC_COMPORT, pool_well):
    ...
    aspirate_SaP_WL(protocolFile, pipet300_single, ReagentReservoir, 7, 100, ASP_FLOW_RATE)
    air_gap_WL(protocolFile, pipet300_single, AIR_GAP_VOL)
    ...
    air_gap_WL(protocolFile, pipet300_single, AIR_GAP_VOL)
    aspirate_SaP_WL(protocolFile, pipet300_single, ReagentReservoir, 15, 50, ASP_FLOW_RATE)
    air_gap_WL(protocolFile, pipet300_single, AIR_GAP_VOL)
    ...
    stopVac(protocolFile, MARC_COMPORT)
    air_gap_WL(protocolFile, pipet300_single, AIR_GAP_VOL)
    aspirate_SaP_WL(protocolFile, pipet300_single, ReagentReservoir, 23, 100, ASP_FLOW_RATE)
    air_gap_WL(protocolFile, pipet300_single, AIR_GAP_VOL)
    stopVent(protocolFile, MARC_COMPORT)
    # TH1X 1
    dispense_SaP_WL(protocolFile, pipet300_single, FilterPlate, pool_well, 100 + 2 * AIR_GAP_VOL, DISP_FLOW_RATE)
    ...
    dispense_SaP_WL(protocolFile, pipet300_multi, DesaltingPlate, sample_well-1, 100 + 2 * AIR_GAP_VOL, DISP_FLOW_RATE)
    blow_out_WL(protocolFile, pipet300_multi)
    aspirate_PSP_SaP_WL(protocolFile, pipet300_multi, DesaltingPlate, sample_well-1, AIR_GAP_VOL, ASP_FLOW_RATE)
    # Isop in filter plate
    # First transfer
    aspirate_PSP_SaP_WL(protocolFile, pipet300_multi, ReagentReservoir, 39, AIR_GAP_VOL, ASP_FLOW_RATE)
    aspirate_SaP_WL(protocolFile, pipet300_multi, ReagentReservoir, 39, 100, ASP_FLOW_RATE)
    aspirate_PSP_SaP_WL(protocolFile, pipet300_multi, ReagentReservoir, 39, AIR_GAP_VOL, ASP_FLOW_RATE)
    ...
    aspirate_PSP_SaP_WL(protocolFile, pipet300_single, FilterPlate, pool_well, AIR_GAP_VOL, ASP_FLOW_RATE)
    aspirate_split_SaP_WL(protocolFile, pipet300_single, FilterPlate, pool_well, 200, precision_asp_depth, precision_flow_rate)
    ...
    startStirring(protocolFile, MARC_COMPORT)
    return_WL(protocolFile, pipet300_single)
    delay_WL(protocolFile, seconds=0, minutes=15)
    stopStirring(protocolFile, MARC_COMPORT)
    vacuum(protocolFile, MARC_COMPORT, 25)
